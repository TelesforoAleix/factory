...
Founder Interface now has a dedicated [Founder Interface / Personal Assistant Department Pack](factory-founder-interface-pack.md). Product expansion now has a dedicated [Product Department Expansion Pack](factory-product-expansion-pack.md). Engineering expansion now has a dedicated [Engineering Department Expansion Pack](factory-engineering-expansion-pack.md).
