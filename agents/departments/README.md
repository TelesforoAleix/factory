...
- [Factory Product Department Expansion Pack](factory-product-expansion-pack.md): reusable project discovery, idea intake, requirements, roadmap/version planning, PRD, feature/task/ticket shaping, acceptance criteria, and product-drift review department.
